...
urlpatterns = patterns('',
                       ...
                       url(r'^v1/geo/data/shapes/$',
                           views.ShapeList.as_view()),
                       url(r'^v1/geo/data/shapes/(?P<pk>[0-9]+)/$',
                           views.ShapeDetail.as_view()),

                       url(r'^v1/geo/data/triple-stores/$',
                           views.TripleStoreList.as_view()),
                       url(r'^v1/geo/data/triple-stores/(?P<pk>[0-9]+)/$',
                           views.TripleStoreDetail.as_view()),

                       url(r'^v1/geo/data/(?P<name>[a-z0-9-_]+)/$',
                           views.DownloadFile.as_view()),

                       url(r'^v1/geo/shape2triple/$',
                           views.ShapeConvert.as_view()),

                       url(r'^v1/geo/gitlog/$', views.GitLog.as_view()),

                       url(r'^v1/geo/users/$', views.UserList.as_view()),
                       url(r'^v1/geo/users/(?P<pk>[0-9]+)/$',
                           views.UserDetail.as_view()),

                       url(r'^v1/geo/current-user/$',
